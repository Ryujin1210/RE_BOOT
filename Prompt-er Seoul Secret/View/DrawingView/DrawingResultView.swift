        ...
        .overlay(content: {
            NavigationBar(title: "작품 기록보기", leftComponent:  {
                ...
                Button {
                    ...
                    Text(!drawingManager.isColorSummaryDone || !drawingManager.isSummaryDone ? "저장중..." : "보러가기")
                        .font(.pretendardSemiBold24)
                        .fontWeight(.semibold)
                        .foregroundColor(.white)
                        .padding(.horizontal, 24)
                        .padding(.vertical, 20)
                        .background( !drawingManager.isColorSummaryDone || !drawingManager.isSummaryDone ? Color.primary300 : Color.primary700)
                        .cornerRadius(10)
                }
                .disabled(!drawingManager.isColorSummaryDone || !drawingManager.isSummaryDone)
            }
        })
